...
public class Animation {
    ...
    /**
     * This method check whether an animation is done playing. by checking the current index of the frame with the length of the animation.
     * 
     * @return {@code true} if the animation is finished, {@code false} otherwise.
     */
    public boolean isAnimationFinished()
    {
		return currFrameIndex >= (frames.size() - 1);
    }

    /**
     * This animation re-start the animation from the beginning.
     * 
     * @see Animation#start()
     */
    public void reload()

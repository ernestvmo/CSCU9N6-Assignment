...
public class Sprite {
	...
	*/
    ...
    /**
     * This method draws the image flipped on the vertical axis.
     * 
     * @param g The graphical object to draw on.
     */
    public void flip(Graphics2D g)
    {
    	g.drawImage(getImage(), (int) (x + width) + xoff, (int) y + yoff, (int) -width, (int) height, null);
    }
    
    /**
     * This method checks if two sprites collide with each other as rectangles.
     * 
     * @param other The other sprite to check collision with.
     * 
     * @return {@code true} if the two sprites touch each other, {@code false} otherwise.
     */
    public boolean boundingBoxCollision(Sprite other)
    {
    ...
    /**
     * This method checks if two sprites collide with each other as circles.
     * 
     * @param other The other sprite to check collision with.
     * 
     * @return {@code true} if the two sprites touch each other, {@code false} otherwise.
     */
    public boolean boundingCircleRectangleCollision(Sprite other)
    {
    	float dx, dy, minimum;
    	
    	dx = this.getX() - other.getX();
    	dy = this.getY() - other.getY();
    	minimum = this.getRadius() + other.getRadius();

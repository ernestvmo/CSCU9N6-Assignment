...
public class FadeFilterStream extends FilterInputStream
{
	...
	public int read(byte[] sample, int offset, int length) throws IOException
	{
		...
		float change = 2.0f * (fadeChange / (float) bytesRead);
	...
	/**
	 * Mutator method for the fade change variable. 
	 * 
	 * @param fadeChange The new value for the change.
	 */
	public void fadeSpeed(float fadeChange)
	{
		this.fadeChange = fadeChange;
	}
	
	/**
	 * Mutator method for the volume of the audio clip. 
	 * 
